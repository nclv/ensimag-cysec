 ...
 * @return result num128, result.t[1] = 1 if it failed to resolve the problem, 0 if it success with t[0]=the solution
 */
...
int main(int argc, char **argv) {
	...
	printf("Test fill_exponents is correct: %s\n\n",
		   test_fill_exponents() ? "true" : "false");
